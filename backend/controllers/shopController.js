...
export const addToCart = async (req, res) => {
  try {
    ...
    if (existingItemIndex > -1) {
      const nextQty = cart.items[existingItemIndex].quantity + Number(quantity);
...
// @desc    Update cart item quantity (set)
// @route   PUT /api/shop/cart
// @access  Private
...
// @desc    Get vendor products (own products)
// @route   GET /api/shop/vendor/products
